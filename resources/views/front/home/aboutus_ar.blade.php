					...
					<div class="row col-mb-50 mb-0">
						...
						<div class="col-lg-4">
							...
							<div class="heading-block fancy-title border-bottom-0 title-bottom-border">
								<h4>لما <span>تختارنا</span></h4>
							</div>

							<p>
								{{$about->why_cheose_us_ar}}
							</p>
						...
						<div class="col-lg-4">
							...
							<div class="heading-block fancy-title border-bottom-0 title-bottom-border">
								<h4>ما هي  <span>مهمتنا</span></h4>
							</div>

							<p>
								{{$about->our_mission_ar}}
							</p>
							...
							<div class="row col-mb-50">
								...
								<div class="col-lg-6">
									<ul class="skills">
										...
										<li data-percent="70">
											<span>المؤتمرات والمشاركات</span>
											<div class="progress">
							...
							<div class="row col-mb-50">
								...
								<div class="col-lg-6" style="padding: 0px;">
									<ul class="skills">
										<li data-percent="100">
											<span>
											احترام جميع التنوعات لجميع الأفراد.
											</span>
											<div class="progress">
											</div>
										</li>
										<li data-percent="100">
											<span>
											إظهار الالتزام بالنزاهة والأخلاق.
											</span>
											<div class="progress">
											</div>
										</li>
										<li data-percent="100">
											<span>
											حافظ على الوعود المقطوعة للآخرين.
											</span>
											<div class="progress">
											</div>
										</li>
										<li data-percent="100">
											<span>
											مساعدة وخدمة والتعامل مع عملائنا بشكل إيجابي.
											</span>
											<div class="progress">
											</div>
										</li>
										<li data-percent="100">
											<span>
											تنفيذ الأفكار والحلول المبتكرة.
											</span>
											<div class="progress">
											</div>
										</li>
			...
			<div class="content-wrap">
				<div class="container clearfix">
					<div class="fslider testimonial testimonial-full " data-animation="fade" data-arrows="false">
						<h3 style="text-align:center;">آراء المستخدمين</h3>
						<div class="flexslider">
							<div class="slider-wrap">
								<div class="slide">
									<div class="testi-content">
										<p>
										اتصلوا بنا عندما كانت الغرف متاحة بالقرب من موقع عملنا. معدلاتهم هي الأفضل دائمًا وهم يقفون وراء التزامهم. في إحدى المناسبات ، واجهتنا مشكلة في وقت تسجيل الوصول. انتهى الأمر بكون الفندق قد زاد من الحجز. اتصلنا بـ المعمل الدوائي وتم حل المشكلة على الفور ، إلى جانب مكالمات مجاملة لنا للاستفسار عن حالتنا وراحتنا.
										</p>
										<div class="xon">
											حسن سيد
										</div>
