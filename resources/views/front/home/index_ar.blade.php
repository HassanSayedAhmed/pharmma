...
<body class="stretched">
	...
	<!-- Top Bar
		...
		<div id="top-bar">
			...
			============================================= -->
			<div id="logo">
			<a href="{{route('front_index_ar')}}" class="standard-logo" data-dark-logo="images/Artboard-5.png"><img src="{{asset('images/Artboard-5.png')}}" alt="Canvas Logo"/></a>
				<a href="{{route('front_index_ar')}}" class="retina-logo" data-dark-logo="images/Artboard-5.png"><img src="{{asset('images/Artboard-5.png')}}" alt="Canvas Logo"/></a>
			</div><!-- #logo end -->
				...
				<div id="rev_slider_679_1_wrapper" class="rev_slider_wrapper fullwidth-container"  style="padding:0px;">
					...
					<div id="rev_slider_679_1" class="rev_slider fullwidthbanner" style="display:none;" data-version="5.1.4">
						<ul>    <!-- SLIDE  -->
							...
							<li  class="dark" data-transition="fade" data-slotamount="1" data-masterspeed="1500" data-thumb="{{asset('front/images/slider/Artboard-1-thumb.jpg')}}" data-delay="10000"  data-saveperformance="off" data-title="Responsive Design">
								<!-- MAIN IMAGE -->
								@if($slider->image)
									<img src="{{$slider->image}}" />
								@else 
									<img src="{{asset('front/images/slider/Artboard-1.png')}}"  alt="kenburns1" data-bgposition="center bottom" data-bgpositionend="center top" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-blurstart="0" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
								@endif
								<!-- LAYERS -->
								<div dir="ltr">
										<!-- LAYER NR. 2 -->
										...
										data-endelementdelay="0.1"
										data-endspeed="1000"
										data-endeasing="Power4.easeIn" style="z-index: 3;"><a href="Events.html" class="button button-border button-white button-light button-large button-rounded text-end m-0"><span>
											تواصل معنا
							...
							{{-- <li  class="dark" data-transition="fade" data-slotamount="1" data-masterspeed="1500" data-thumb="{{asset('front/images/slider/Artboard-1-thumb.jpg')}}" data-delay="10000"  data-saveperformance="off" data-title="Responsive Design">
								...
								<div dir="ltr">
										...
										data-textAlign="center"
										data-endeasing="Power4.easeIn" style="z-index: 3; max-width: 650px; white-space: normal;">
										الرواد في هذا المجال بشهادات الجودة المعتمدة
									</div>
							...
							<!-- SLIDE  -->
							<li data-transition="slideup" data-slotamount="1" data-masterspeed="1500" data-thumb="{{asset('front/images/slider/Artboard-2-thumb.jpg')}}" data-delay="10000"  data-saveperformance="off"  data-title="Unlimited Possibilities">
								<!-- MAIN IMAGE -->
								<img src="{{asset('front/images/slider/Artboard-2.jpg')}}"  alt="kenburns6" data-bgposition="center bottom" data-bgpositionend="center top" data-kenburns="on" data-duration="10000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-blurstart="0" data-blurend="0" data-offsetstart="0 0" data-offsetend="0 0" class="rev-slidebg" data-no-retina>
								<!-- LAYERS -->
								<div dir="ltr">
										<!-- LAYER NR. 2 -->
										<div class="tp-caption customin ltl tp-resizeme revo-slider-caps-text text-uppercase"
										...
										data-endelementdelay="0.1"
										data-endspeed="1000"
										data-endeasing="Power4.easeIn" style="z-index: 3;"><a href="Events.html" class="button button-border button-large button-rounded text-end m-0"><span>
										تواصل معنا
										</span><i class="icon-angle-right"></i></a></div>
									</div>
							</li> --}}
	...
	<div class="container about-us-ext">
		<div class="row">
			...
			<div class="col-lg-4 m-b-60">
				<h2>معلومات عنا</h2>
				<h4>
					المعمل الدوائي من صفوة الشركات الطبية التي يديرها أميز المستشارون في المجال الطبي
					.</h4>
				<p class="lead" style="text-transform: lowercase;">
				 .المعمل الدوائي من الشركات الرائدة في المجال الدوائي في مصر وتطمح لتطوير وتحسين جودة الخدمات لمنطقة الشرق الأوسط وأفريقيا من خلال التصنيع المحلي التطوير الدوائي والريادة في أفكار المجال الدوائي علي مستوي العالم 
				</p>
				<a href="About Us.html" class="btn btn-outline btn-roundeded unique-btn" style="background-color: #273b76;color: #FFF;">للمزيد من المعلومات</a>
			</div>
				...
				<div class="row">
						...
						<div class="col-sm-12 col-lg-6 fbox-color-aboutus " data-animate="fadeInDown" >
							<div class="feature-box fbox-effect ">
								...
								<p style="padding: 15px;" > تهدف شركة الأدوية الخاصة بنا إلى تحسين نوعية الحياة لمنطقة الشرق الأوسط وشمال إفريقيا بأكملها وإفريقيا ، من خلال التصنيع المحلي وتطوير أحدث الابتكارات في صناعة الأدوية في جميع أنحاء العالم.</p>
							</div>
						</div>
						<!-- end: features box -->
						...
						<div class="col-sm-12 col-lg-6 fbox-color-aboutus " data-animate="fadeInLeft" >
							<div class="feature-box fbox-effect">
								...
								<p style=";padding: 15px;">قيادة صناعة الأدوية في مصر من خلال التغيير والابتكار لتصبح شركة دولية تقدم رعاية صحية أفضل لمزيد من المرضى حول العالم.</p>
							</div>
						</div>
						<!-- end: features box -->
						...
						<div class="col-sm-12 col-lg-6">
							<div class="feature-box fbox-effect fbox-color-aboutus " data-animate="fadeInUp" >
								...
								<p style="padding: 15px;">التركيز على الجودة والحداثة وشغفنا بوضع المريض أولاً هي أهم ركائز فلسفتنا. <br>
								توفير بيئة عمل آمنة ومليئة بالتحديات لجميع أفراد عائلة.<br>
رد الجميل للمجتمع من خلال البدء في مبادرات خيرية تحدث تغييرًا إيجابيًا ملحوظًا.</p>
							</div>
						</div>
						<!-- end: features box -->
					...
					<div class="col-sm-12 col-lg-6 fbox-color-aboutus " data-animate="fadeInRight" >
						<div class="feature-box fbox-effect">
							...
							واحدة من أسرع شركات الأدوية نموًا في منطقة الشرق الأوسط وشمال إفريقيا وفقًا لتقارير IQVIA. مكان مثالي للتطوير الوظيفي وفرص النمو مع أكثر من 100 منتج في السوق و 150 منتجًا آخر في خطوط الأنابيب التي تغطي جميع الفئات العلاجية.
							</p>
						</div>
					</div>
					<!-- end: features box -->
				...
				<div class="container clearfix">
					...
					<div class="row col-mb-50">
						<div class="col-sm-6 col-lg-6 text-center">
							...
							<h5>تم اختباره وعلاجه من فيروس التهاب الكبد سي</h5>
						</div>
							...
							<div class="entry event mb-3 col-lg-6">
								<div class="grid-inner row align-items-center g-0 p-4">
									...
									<div class="col-md-12">
										...
										<div class="entry-content">
											<a href="#" class="btn btn-infoss btn-sm unique-btn">للمزيد</a> <a href="#" class="btn btn-dangerss btn-sm unique-btn2">واتساب</a>
										</div>
									</div>
								</div>
							</div>
	...
	<!-- testimonials
		============================================= -->
		<section id="content" class="testimonials-edit- blogs-in-home" dir="ltr">
			<div class="content-wrap">
				<div class="container clearfix">
					...
					<div id="carouselExampleControls" class="carousel slide" data-ride="carousel" >
						<div class="carousel-inner" style="width: 90%;margin-left:3.25rem">
							<div class="carousel-item active" data-interval="10000" style="direction: rtl">
								<div class="card mb-3" >
									<div class="row no-gutters">
										<div class="col-md-4">
											@if($blogActive->image != null)
												<a href="{{route('front_blog_detail',['blog'=>$blogActive->id])}}" data-lightbox="image"><img src="{{$blogActive->image}}" alt="Standard Post with Image"></a>
											@else
												<a href="{{route('front_blog_detail',['blog'=>$blogActive->id])}}" data-lightbox="image"><img src="{{asset('/uploads/defaults/defualt_blog.jpg')}}" alt="Standard Post with Image"></a>
											@endif
										</div>
										<div class="col-md-8">
											<div class="card-body">
												<h5 class="card-title"><a href="{{route('front_blog_detail',['blog'=>$blogActive->id])}}">{{$blogActive->title_ar}}</a> </h5>
												<p class="card-text">{{$blogActive->description_ar}}</p>
							...
							<div class="carousel-item" data-interval="10000" style="direction: rtl" >
								<div class="card mb-3" >
									<div class="row no-gutters">
										<div class="col-md-4">
											@if($blog->image != null)
										...
										<div class="col-md-8">
											<div class="card-body">
												<h5 class="card-title"><a href="{{route('front_blog_detail',['blog'=>$blog->id])}}">{{$blog->title_ar}}</a> </h5>
												<p class="card-text">{{$blogActive->description_ar}}</p>
												{{-- <p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p> --}}
											</div>
										</div>
