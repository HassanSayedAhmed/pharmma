...
<body class="stretched">
	...
	<!-- Top Bar
		...
		<div id="top-bar">
			...
			============================================= -->
			<div id="logo">
				<a href="{{route('front_index')}}" class="standard-logo" data-dark-logo="images/Artboard-5.png"><img src="{{asset('images/Artboard-5.png')}}" alt="Canvas Logo"/></a>
				<a href="{{route('front_index')}}" class="retina-logo" data-dark-logo="images/Artboard-5.png"><img src="{{asset('images/Artboard-5.png')}}" alt="Canvas Logo"/></a>
			</div><!-- #logo end -->
					...
					<div id="rev_slider_679_1" class="rev_slider fullwidthbanner" style="display:none;" data-version="5.1.4">
						<ul>    <!-- SLIDE  -->
							@foreach ($sliders as $slider)
								<li  class="dark" data-transition="fade" data-slotamount="1" data-masterspeed="1500" data-thumb="{{$slider->image}}" data-delay="10000"  data-saveperformance="off" data-title="Responsive Design">
									<!-- MAIN IMAGE -->
									@if($slider->image)
									...
									data-endspeed="1000"
									data-endeasing="Power4.easeIn" style="z-index: 3; white-space: nowrap;">{{$slider->top_title}}</div>
									...
									data-endeasing="Power4.easeIn" style="z-index: 3; max-width: 650px; white-space: normal;">{{$slider->sub_title}}</div>
...
<section>
					...
					<div id="oc-events" class="owl-carousel events-carousel carousel-widget" data-pagi="false" data-items-md="1" data-items-lg="2" data-items-xl="2">
						...
						<div class="oc-item row">
								...
								<div class="grid-inner row align-items-center g-0 p-4">
									...
									<div class="col-md-12">
										...
										<div class="entry-content">
											...
											<a href="https://api.whatsapp.com/send/?phone={{$appSetting->whatsapp_number}}&text=Hi Available" class="btn btn-dangerss btn-sm unique-btn2">WhatsApp <br>
											</a>
										</div>
									</div>
								</div>
							...
							<div class="entry event mb-3 col-lg-6">
								<div class="grid-inner row align-items-center g-0 p-4">
									<div class="col-md-12 mb-md-0">
										<a href="{{route('front_product_detail',['product'=>$products[$product+1]['id']])}}" class="entry-image">
	...
	<!-- testimonials
		============================================= -->
		<section id="content" class="testimonials-edit- blogs-in-home">
			<div class="content-wrap">
				<div class="container clearfix">
							...
							<div class="carousel-item active" data-interval="10000">
								<div class="card mb-3" >
									<div class="row no-gutters">
										...
										<div class="col-md-8">
											<div class="card-body">
												<h5 class="card-title"><a href="{{route('front_blog_detail',['blog'=>$blogActive->id])}}">{{$blogActive->title}}</a> </h5>
												<p class="card-text">{{$blogActive->description}}</p>
							...
							<div class="carousel-item" data-interval="10000">
								<div class="card mb-3" >
									<div class="row no-gutters">
										...
										<div class="col-md-8">
											<div class="card-body">
												<h5 class="card-title"><a href="{{route('front_blog_detail',['blog'=>$blog->id])}}">{{$blog->title}}</a> </h5>
