                                ...
                                <div class="entry event mb-3 col-lg-4">
                                    <div class="grid-inner row align-items-center g-0 p-4">
                                        <div class="col-md-12 mb-md-0">
                                            <a href="{{route('front_product_detail_ar',['product'=>$product->id])}}" class="entry-image">
                                                @if($product->image)
                                            ...
                                            @foreach ($category->subCategory as $sub)
                                                @if ($currentSubCategory != null)
                                                    @if ($sub->id == $currentSubCategory->id)
                                                        <a class="dropdown-item active" href="{{route('front_products_ar',['category'=>$sub->id])}}">{{$sub->name_ar}}</a>
                                                    @else
