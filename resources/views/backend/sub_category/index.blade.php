...
@section('body')
<div class='modal fade' id='manage_SubCategory_modal' tabindex='-1' role='dialog' aria-labelledby='SubCategory_modal' aria-hidden='true'>
...
<div class="col-xl-12 col-lg-12 col-sm-12">
    ...
    <div class="card-header">
        <a id="add_SubCategory" href="javascript:void(0)"><i class="fa fa-plus"></i> Add Sub Category</a>
    </div>
    <div class="card-body">
        <table id="SubCategory_table" class="table dt-table-hover" style="width:100%">
            <thead>
                <tr>
                    <th>#</th>
                    <th>Name</th>
...
@section('scripts')
   <script>
        $(document).ready(function(){
            ...
            $('#add_SubCategory').on('click', function () {

                var modal = $('#manage_SubCategory_modal').clone();
