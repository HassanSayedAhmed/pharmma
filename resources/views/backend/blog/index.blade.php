            ...
            <div class='modal-content'>
                ...
                <div class='modal-body'>
                    ...
                    <div class="form-group">
                        ...
                        <textarea required class="form-control" id="description" name="description" title="description" placeholder="description"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Description Arabic</label>
                        <textarea required class="form-control" id="description_ar" name="description_ar" title="description Arabic" placeholder="Description Arabic"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Image</label>
